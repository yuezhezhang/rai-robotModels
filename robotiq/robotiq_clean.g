...
robotiq_arg2f_base_link_1 (robotiq_arg2f_base_link) 	{ , shape:mesh, color:[0.1, 0.1, 0.1, 1], mesh:'meshes/visual/robotiq_arg2f_85_base_link.ply', meshscale:0.001, visual }
...
finger_joint (robotiq_arg2f_base_link>finger_joint) 	{ , joint:rigid, limits:[0, 0.8, 2, 1000, 1], ctrl_limits:[2, 1000, 1] }
left_inner_knuckle_joint (robotiq_arg2f_base_link>left_inner_knuckle_joint) 	{ , joint:rigid, limits:[0, 0.8757, 2, 1000, 1], mimic:(finger_joint), ctrl_limits:[2, 1000, 1] }
right_outer_knuckle_joint (robotiq_arg2f_base_link>right_outer_knuckle_joint) 	{ , joint:rigid, limits:[0, 0.81, 2, 1000, 1], mimic:(finger_joint), ctrl_limits:[2, 1000, 1] }
right_inner_knuckle_joint (robotiq_arg2f_base_link>right_inner_knuckle_joint) 	{ , joint:rigid, limits:[0, 0.8757, 2, 1000, 1], mimic:(finger_joint), ctrl_limits:[2, 1000, 1] }
...
left_outer_knuckle_1 (left_outer_knuckle) 	{ , shape:mesh, color:[0.792157, 0.819608, 0.933333, 1], mesh:'meshes/visual/robotiq_arg2f_85_outer_knuckle.ply', meshscale:0.001, visual }
left_outer_knuckle>left_outer_finger_joint (left_outer_knuckle) 	{  Q:[0, 0.0315, -0.0041, 1, 0, 0, 0] }
left_inner_knuckle_1 (left_inner_knuckle) 	{ , shape:mesh, color:[0.1, 0.1, 0.1, 1], mesh:'meshes/visual/robotiq_arg2f_85_inner_knuckle.ply', meshscale:0.001, visual }
right_outer_knuckle_1 (right_outer_knuckle) 	{ , shape:mesh, color:[0.792157, 0.819608, 0.933333, 1], mesh:'meshes/visual/robotiq_arg2f_85_outer_knuckle.ply', meshscale:0.001, visual }
right_outer_knuckle>right_outer_finger_joint (right_outer_knuckle) 	{  Q:[0, 0.0315, -0.0041, 1, 0, 0, 0] }
right_inner_knuckle_1 (right_inner_knuckle) 	{ , shape:mesh, color:[0.1, 0.1, 0.1, 1], mesh:'meshes/visual/robotiq_arg2f_85_inner_knuckle.ply', meshscale:0.001, visual }
...
left_outer_finger_1 (left_outer_finger) 	{ , shape:mesh, color:[0.1, 0.1, 0.1, 1], mesh:'meshes/visual/robotiq_arg2f_85_outer_finger.ply', meshscale:0.001, visual }
left_outer_finger>left_inner_finger_joint (left_outer_finger) 	{  Q:[0, 0.0061, 0.0471, 1, 0, 0, 0] }
right_outer_finger_1 (right_outer_finger) 	{ , shape:mesh, color:[0.1, 0.1, 0.1, 1], mesh:'meshes/visual/robotiq_arg2f_85_outer_finger.ply', meshscale:0.001, visual }
...
left_inner_finger_joint (left_twist) 	{ , joint:rigid, limits:[0, 0.8757, 2, 1000, 1], mimic:(finger_joint), ctrl_limits:[2, 1000, 1] }
right_twist (right_outer_finger>right_inner_finger_joint) { Q:<d(180 0 0 1)> }
right_inner_finger_joint (right_twist) 	{ , joint:rigid, limits:[0, 0.8757, 2, 1000, 1], mimic:(finger_joint), ctrl_limits:[2, 1000, 1] }
left_inner_finger (left_inner_finger_joint) 	{ Q:<d(180 0 0 1)> }
right_inner_finger (right_inner_finger_joint) 	{ Q:<d(180 0 0 1)>  }
left_inner_finger_1 (left_inner_finger) 	{ , shape:mesh, color:[0.1, 0.1, 0.1, 1], mesh:'meshes/visual/robotiq_arg2f_85_inner_finger.ply', meshscale:0.001, visual }
left_inner_finger>left_inner_finger_pad_joint (left_inner_finger) 	{  Q:[0, -0.0220203, 0.03242, 0.707107, 0, -0.707107, 0] }
right_inner_finger_1 (right_inner_finger) 	{ , shape:mesh, color:[0.1, 0.1, 0.1, 1], mesh:'meshes/visual/robotiq_arg2f_85_inner_finger.ply', meshscale:0.001, visual }
