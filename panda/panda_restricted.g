Include='panda_clean_restricted.g'
...
panda_coll0(base)	{ shape:capsule color:[1.,1.,1.,.2] size:[.1 .1] Q:<t(-.04 .0 .03) d(90 0 1 0)>, contact:-2  }
panda_coll0b(base)	{ shape:capsule color:[1.,1.,1.,.2] size:[.2 .08] Q:<t(-.02 .0 .0) d(90 1 0 0)>, contact:-2  }

panda_coll1(panda_joint1)	{ shape:capsule color:[1.,1.,1.,.2] size:[.2 .08] Q:<d(90 0 1 0) t(0 0 -.15)>, contact:-2  }
panda_coll3(panda_joint3)	{ shape:capsule color:[1.,1.,1.,.2] size:[.2 .1] Q:<d(90 0 1 0) t(0 0 -.15)>, contact:-2  }
panda_coll5(panda_joint5)	{ shape:capsule color:[1.,1.,1.,.2] size:[.22 .12] Q:<d(90 0 1 0) t(0 .02 -.2)>, contact:-2  }

panda_coll2(panda_joint2)	{ shape:capsule color:[1.,1.,1.,.2] size:[.12 .11] Q:<d(90 0 1 0) t(0 0 .0)>, contact:-2  }
panda_coll4(panda_joint4)	{ shape:capsule color:[1.,1.,1.,.2] size:[.12 .1] Q:<d(90 0 1 0) t(0 0 .0)>, contact:-2  }
panda_coll6(panda_joint6)	{ shape:capsule color:[1.,1.,1.,.2] size:[.1 .1] Q:<d(90 0 1 0) t(0 .0 -.04)>, contact:-2  }
panda_coll7(panda_joint7)	{ shape:capsule color:[1.,1.,1.,.2] size:[.1 .1] Q:<d(90 0 1 0) t(0 .0 .05)>, contact:-2  }
