...
shoulder_lift_joint (shoulder_lift_joint_origin) 	{ , joint:hingeZ, limits:[-6.2832, 6.2832, 3.14, -1, 150], ctrl_limits:[3.14, -1, 150] }
...
wrist_1_joint (wrist_1_joint_origin) 	{ , joint:hingeZ, limits:[-6.2832, 6.2832, 6.28, -1, 28], ctrl_limits:[6.28, -1, 28] }
...
wrist_2_joint (wrist_2_joint_origin) 	{ , joint:hingeY, limits:[-6.2832, 6.2832, 6.28, -1, 28], ctrl_limits:[6.28, -1, 28] }
